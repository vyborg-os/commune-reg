    ...
    <div class="col-lg-6 container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mt-3">
                ...
                <input id="cpassword" type="password" placeholder="confirm password" name="cpassword" required/>
            </div>
            
            <div class="col-lg-12 mt-3">
            <input type="hidden" name="register">
            <center><button class="btn btn--form" type="submit" style="background-color: #3717ba;
    color: #fdf2e9; outline: none;">Create Account <i class="loader fa fa-spinner fa-spin" style="color: white; display: none;"></i></button>
                </center>
        </div>
        </div>
        </form>
